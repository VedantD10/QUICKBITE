    ...
    <div className="relative min-h-[85vh] flex flex-col justify-center overflow-hidden text-white animate-fade-in">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 bg-slate-900/60 border border-white/20 backdrop-blur-xl rounded-3xl p-7 shadow-2xl space-y-5 animate-scale-in">
            ...
            <div className="space-y-3">
              {Object.entries(DEMO_USERS).map(([roleKey, info]) => (
                <button
                  ...
                  className="w-full p-4 rounded-2xl bg-white/10 border border-white/15 hover:border-orange-400 hover:bg-orange-500/20 text-left transition-all group flex items-center justify-between shadow-sm"
                >
                  <div>
                  ...
                  <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-slate-200 group-hover:text-orange-400 group-hover:border-orange-400 shadow-sm">
                    →
                  </div>
                </button>
              ))}
